...
import { AuthService, AuthServiceImpl, AuthServiceProvider } from './auth.service';
...
import { AuthRepository, AuthRepositoryImpl, AuthRepositoryProvider } from './auth.repository';
