...
describe('Signup', () => {
  test('should renders a form', async () => {
    const wrapper = mount(Signup)

    expect(wrapper.find('form').exists()).toBe(true)
  })

  test('should renders a signup form', async () => {
    const wrapper = mount(Signup)
  ...
  test('should renders a error message when the two password dont match', async () => {
    const wrapper = mount(Signup)
  ...
  test('should renders error messages when form is submitted with invalid data', async () => {
    const wrapper = mount(Signup)
